...
Invoke at one of three checkpoints:
...
5. **If GPT's feedback raises questions needing user input or preference, ask the user rather than making assumptions.**
6. Briefly note any material changes you adopted from the review.
7. If the GPT review could not be run, say that explicitly before proceeding.
